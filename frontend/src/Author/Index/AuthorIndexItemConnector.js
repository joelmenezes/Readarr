...
import createArtistMetadataProfileSelector from 'Store/Selectors/createAuthorMetadataProfileSelector';
...
function createMapStateToProps() {
  return createSelector(
    ...
    (
      ...
      const latestAlbum = _.maxBy(author.books, (book) => book.releaseDate);
