...
import EditArtistModalConnector from 'Author/Edit/EditAuthorModalConnector';
import DeleteArtistModal from 'Author/Delete/DeleteAuthorModal';
import ArtistHistoryTable from 'Author/History/AuthorHistoryTable';
import AuthorAlternateTitles from './AuthorAlternateTitles';
import ArtistDetailsSeasonConnector from './AuthorDetailsSeasonConnector';
import AuthorDetailsSeriesConnector from './AuthorDetailsSeriesConnector';
import ArtistTagsConnector from './AuthorTagsConnector';
        ...
        <PageToolbar>
          <PageToolbarSection>
            ...
            <PageToolbarButton
              ...
              title={hasMonitoredAlbums ? undefined : 'No monitored albums for this author'}
                ...
                <div className={styles.titleRow}>
                  ...
                  <div className={styles.artistNavigationButtons}>
                    <IconButton
                      ...
                      size={30}
                      title={`Go to ${previousArtist.authorName}`}
                    ...
                    <IconButton
                      ...
                      size={30}
                      title={`Go to ${nextArtist.authorName}`}
