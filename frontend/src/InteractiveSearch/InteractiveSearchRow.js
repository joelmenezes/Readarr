    ...
    return (
      <TableRow>
        ...
        <ConfirmModal
          ...
          kind={kinds.WARNING}
          title="Grab Release"
          message={`Readarr was unable to determine which author and album this release was for. Readarr may be unable to automatically import this release. Do you want to grab '${title}'?`}
          confirmLabel="Grab"
