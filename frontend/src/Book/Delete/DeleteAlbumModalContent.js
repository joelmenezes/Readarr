...

          {
            !addImportListExclusion &&
              <div className={styles.deleteFilesMessage}>
                <div>If you don't add an import list exclusion and the author has a metadata profile other than 'None' then this album may be re-added during the next author refresh.</div>
              </div>
          }
